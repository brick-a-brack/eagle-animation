...
const actions = {
  ...
  APP_CAPABILITIES: async () => {
    const capabilities = ['REMOTE_CAMERAS', 'EXPORT_VIDEO', 'EXPORT_FRAMES', 'BACKGROUND_SYNC', 'EXPORT_VIDEO_H264', 'EXPORT_VIDEO_HEVC', 'EXPORT_VIDEO_PRORES', 'EXPORT_VIDEO_VP8', 'EXPORT_VIDEO_VP9'];
    return capabilities;
  },
