...
const ProjectSettingsWindow = ({ t, onProjectSettingsChange = () => {}, onProjectDelete = () => {}, title = '', fps = 12, ratio = null }) => {
  ...
  const RATIOS = [
    ...
    { value: '4:3', label: '4:3' }, // 1.33
    { value: '16:9', label: '16:9' }, // 1.77
    { value: '1.85:1', label: '1.85' }, // 1.85
    { value: '2.39:1', label: '2.39' }, // 2.39
    { value: '1:1', label: '1' }, // 1
    { value: '9:16', label: '9:16' }, // 0.56
    { value: '3:4', label: '3:4' }, // 0.75
  ...
  return (
    <div className={style.actions}>
      ...
      <FormGroup label={t('Animation ratio')} description={t('The ratio of your animation')}>
        <div style={{ display: 'inline-block' }}>
          <Select options={RATIOS} control={control} register={register('ratio')} />
        </div>
        {watch('ratio') === 'custom' && (
          <div style={{ display: 'inline-block' }}>
            <NumberInput style={{ marginLeft: 'var(--space-big)' }} min={0} max={8} step={0.01} register={register('customRatio')} />
          </div>
        )}
      </FormGroup>
