...
export const DEVICE = !document ? null : window.IPC ? 'ELECTRON' : (document.URL.includes('ms-appx-web:///')) ? 'WINDOWS' : (!document.URL.includes('http://') && !document.URL.includes('https://')) ? 'ANDROID' : sessionStorage.getItem('isPWA') ? 'PWA' : 'WEB';
